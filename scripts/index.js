const keyBoard = [
    ...
    {"enMode": "Shift", "enShitMode": "CapsLock", "ruMode": "CapsLock", "ruShiftMode": "CapsLock", "size": "large", "row": 4, "color": "black"},
    ...
    {"enMode": "Shift", "enShitMode": "Enter", "ruMode": "Enter", "ruShiftMode": "Enter", "size": "large", "row": 4, "color": "black"},
    ...
    keyBoard.forEach((item, index) => {
        ...
        keyBoardStr += `<div class="keyboard__item">
                          <span class="keyboard__item_en">
                            <span class="item ${item.size} ${item.color}">
                              ${item.enMode}
                            </span>
                            <span class="item shift-mode hidden">
                              ${item.enShitMode}
                            </span>
                          </span>
...
function checkKeyValue(element) {
    ...
    if (element.innerHTML.trim() == "Tab") {
        ...
        textarea.value = textarea.value.slice(0, textarea.value.length - 1);
               ...
               element.innerHTML.trim() != "CapsLock"    && element.innerHTML.trim() != "Win" &&
               element.innerHTML.trim() != "Shift"       && element.innerHTML.trim() != "Del" &&
               element.innerHTML.trim() != "Enter"       &&
               element.innerHTML.trim() != "" && element.innerHTML.trim() != "Backspace")
    {
